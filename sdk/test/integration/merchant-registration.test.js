...
test("register -> get -> verify merchant round-trips on testnet", { skip: !env && "TESTNET_RPC_URL not set — skipping testnet integration test" }, async () => {
    if (!env)
        return;
    ...
    assert.ok(merchant === null || merchant === undefined || typeof merchant === "object", "get_merchant should return an object, null, or undefined");
    void businessName; // reserved for the real register_merchant call above
});
//# sourceMappingURL=merchant-registration.test.js.map