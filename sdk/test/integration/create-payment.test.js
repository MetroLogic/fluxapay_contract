...
test("createPayment on testnet returns the expected response shape", { skip: !env && "TESTNET_RPC_URL not set — skipping testnet integration test" }, async () => {
    if (!env)
        return;
...
//# sourceMappingURL=create-payment.test.js.map