...
test("create -> verify -> settle payment lifecycle on testnet", { skip: !env && "TESTNET_RPC_URL not set — skipping testnet integration test" }, async () => {
    if (!env)
        return;
...
//# sourceMappingURL=payment-lifecycle.test.js.map